    ...
    return {
      ...
      shortcuts: [
        ...
        },
        {
          name: 'حاسبة الزكاة',
          short_name: 'زكاة',
          description: 'احسب زكاة مالك',
          url: './?action=zakat',
          icons: [{
            src: buildShortcutIcon('🤲', '#10b981'),
            sizes: '192x192',
            type: 'image/svg+xml'
          }]
        },
  ...
  function executeAction(action) {
    switch (action) {
      ...
      case 'scan-bill':
        ...
        break;
      case 'zakat':
        // Open Zakat tab/modal
        const zakatBtn = document.getElementById('openZakatBtn');
        if (zakatBtn) zakatBtn.click();
        else if (window.openZakatCalculator) window.openZakatCalculator();
        break;
      case 'voice-input':

...
(function bootstrap() {
  ...
  function startModules() {
    const modules = [
      ...
      ['Sidebar',           () => window.Sidebar?.init?.()],
      ['DedicatedPages',    () => window.DedicatedPages?.init?.()],
      ['ChatsPage',         () => window.ChatsPage?.init?.()],
      ...
      // ─── ميزات جديدة (12 ميزة) ───
      ['ExtraThemes',       () => window.ExtraThemes?.init?.()],
      ['QuickActions',      () => window.QuickActions?.init?.()],
      ['VisualCalendar',    () => window.VisualCalendar?.init?.()],
      ['BudgetChallenges',  () => window.BudgetChallenges?.init?.()],
      ['SmartNotifs',       () => window.SmartNotifs?.init?.()],
      ['PWAShortcuts',      () => window.PWAShortcuts?.init?.()],
      ['FeaturesUI',        () => window.FeaturesUI?.init?.()],
      ['FabController',     () => window.FabController?.init?.()],
      ['UnreadBadges',      () => window.UnreadBadges?.init?.()],
      ['MoneyInsights',     () => window.MoneyInsights?.init?.()],
      ['Onboarding',        () => window.Onboarding?.init?.()],
      ['YearlyCharts',      () => window.YearlyCharts?.init?.()]
    ];
